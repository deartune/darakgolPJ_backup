	...
	<nav id="topMenu" class="colorlib-nav" role="navigation">
				...
				<div class="row">
					...
					<div class="col-xs-10 text-right menu-1">
						<ul>
							...
							<li class="active"><a href="do.html">Do</a></li>
		...
		<!-- 객실 서비스 아이템 테이블 -->
			<div class="container" id="about">
				<p style="font-size: 20px;font-weight: bold;color:black; margin-top:50px">객실 서비스 아이템</p>
				<div class="row">
					<table class="table">
						<thead>
							<tr>
							<!-- <th scope="col"><img src="images/bedroom_icon.jpg"></th>
							<th scope="col"><img src="images/bathroom_icon.jpg"></th>
							<th scope="col"><img src="images/minibar_icon.jpg"></th>
							<th scope="col"><img src="images/facility_icon.jpg"></th> -->
							<th scope="col" style="font-size:18px;">침실</th>
							<th scope="col" style="font-size:18px;">화장실</th>
							<th scope="col" style="font-size:18px;">미니바</th>
							<th scope="col" style="font-size:18px;">시설</th>
							</tr>
						</thead>
						<tbody> 
							<tr>
							<th scope="row">- 침대<br>- 베개 셀렉션 (Soft or Firm)<br>- 42인치 LCD TV <br>- 케이블 채널<br>- 커피 포트<br>- 개인 금고<br>- 업무용 책상<br>- 슬리퍼, 목욕가운<br>- 와인잔, 커피잔<br>- 모닝콜 서비스<br>- 다리미, 다리미 판<br>- 110V, 220V</th>
							<td>- 대형 편백나무 욕조<br>- 샤워부스<br>- ETRO 어메니티 5종<br>- 헤어 드라이기<br>- 비데</td>
							<td>- 네스프레소 커피캡슐 3개<br>- 맥주 2캔<br>- 믹스 너츠<br>- 젤리<br>- 초코바<br>- 소프트 드링크 3캔<br>- 생수 2병</td>
							<td>- 무료 WIFI<br>- 천장 에어컨 &amp; 히터<br>- 온돌<br>- 공기청정기 &amp; 가습기<br>- 개별 냉난방 조절 시스템</td>
							</tr>
						</tbody>
					</table>	
