...
?>		
    ...
    <table class="table text-right;" id="tblRoom" bored="1">
        <tr>
            ...
            <th>기간</th>
            <th>적용일</th>
			<th style="text-align: right; ">일일요금</th>
            <th style="text-align: right; ">적용요금 &nbsp;</th>
        </tr>
<?
...
?>	
            ...
            <tr>
                ...
                <td align="right"><?=number_format($total_price)?>원</td>
            </tr>
        </table>
    ...
    <table class="table" bored="1">
        ...
        <tr>
            <td>예약요청사항</td>
            <td colspan="5"><textarea style="width:100%;border:1;text-overflow:ellipsis;" rows=3 readonly><?=$book_comment?></textarea></td>
        </tr>
    </table>
    </center>
                </div> 
