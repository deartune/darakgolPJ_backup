...
?>
							...
							<div class="item">
								...
								<div class="desc text-center">
									<h3><a href="rooms-suites.html"><?=$room_name?></a></h3>
									<p class="price">
										<span class="price-room"><?=number_format("$room_price")?></span>
...
<?}?>	
					...
					<div class="col-md-12 text-center animate-box">
						<a href="#" style="font-size:2.0em">View all rooms <i class="icon-arrow-right3"></i></a>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row">
					<div class="col-md-12 text-center">
						<p>
							...
							Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | 아보카도나무
						</p>
					</div>
				</div>
			</div>
