...
<div class="col-md-10 col-md-offset-1 animate-box">
						 <table class="w3-table-all w3-hoverable">
						    <thead>
						      <tr class="w3-light-grey pa">
						           <th width='2.5%'>No</th>
						        <th width='2.5%'><?=$notice_id?></th>
						        <th width='95%'><?=$notice_title?></th></tr>
						    </thead></table></div>
						    <div class="col-md-10 col-md-offset-1 animate-box" style="text-align: justify;">
						        <br>
						   <pre><?=$notice_content?></pre>

								<div style="text-align: right;"><?=$notice_wdate?></div>
								<hr>
						</div><div class="col-md-10 col-md-offset-1 animate-box" style="Right-align content"> <a href='notice.php'>[목록보기]</a></div>
